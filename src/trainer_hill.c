...
static const enum Item sPrizeListToxic[]       = {ITEM_TM_VENOSHOCK,     ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
...
static const enum Item sPrizeListTorment[]     = {ITEM_TM_ROUND,         ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
...
static const enum Item sPrizeListAttract[]     = {ITEM_TM45,             ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
