...
const u8 gText_XNatureMetAtYZ[] = _("Met at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}, {DYNAMIC 2}{DYNAMIC 5}\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
const u8 gText_XNatureHatchedAtYZ[] = _("Hatched at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}, {DYNAMIC 2}{DYNAMIC 5}\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
const u8 gText_XNatureObtainedInTrade[] = _("Obtained in a trade.");
const u8 gText_XNatureFatefulEncounter[] = _("Obtained in a fateful\nencounter at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");
const u8 gText_XNatureProbablyMetAt[] = _("Probably met at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}, {DYNAMIC 2}{DYNAMIC 5}\n{DYNAMIC 0}{DYNAMIC 4}{DYNAMIC 1}.");
const u8 gText_RentalPokemon[] = _("Rental Pokémon");
const u8 gText_XNatureMetSomewhereAt[] = _("Met somewhere at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");
const u8 gText_XNatureHatchedSomewhereAt[] = _("Hatched somewhere at {LV_2}{DYNAMIC 0}{DYNAMIC 3}{DYNAMIC 1}.");
...
const u8 gText_OpenPokedex[] = _("{START_BUTTON} POKéDEX");
