...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_BUNNELBY] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PICKUP, ABILITY_CHEEK_POUCH, ABILITY_NONE },
...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
    ...
    [SPECIES_PYROAR_M] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_RIVALRY, ABILITY_UNNERVE, ABILITY_FIRE_MANE },
        .bodyColor = BODY_COLOR_BROWN,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_SPRITZEE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_HEALER, ABILITY_LINGERING_AROMA, ABILITY_AROMA_VEIL },
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_AROMATISSE, CONDITIONS({IF_HOLD_ITEM, ITEM_SACHET})}),
    },
    ...
    [SPECIES_SKRELP] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 45, SPECIES_DRAGALGE}),
    },
    ...
    [SPECIES_DEDENNE] =
    {
        ...
        .abilities = { ABILITY_CHEEK_POUCH, ABILITY_STATIC, ABILITY_PLUS },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_CARBINK] =
    {
        ...
        .evolutions = EVOLUTION({EVO_SCRIPT_TRIGGER, EVO_TRIGGER_CARBINK_WHITE_ROCK, SPECIES_DIANCIE}),
    },
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_SLIGGOO},
                                {EVO_ITEM, ITEM_BLACK_AUGURITE, SPECIES_SLIGGOO_HISUI}),
    },
    ...
    [SPECIES_GOURGEIST_AVERAGE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_FRISK, ABILITY_INSOMNIA },
        .bodyColor = BODY_COLOR_BROWN,
