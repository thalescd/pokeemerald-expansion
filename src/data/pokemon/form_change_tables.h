...
{
#if P_MEGA_EVOLUTIONS
    {FORM_CHANGE_BATTLE_HP_PERCENT_SEND_OUT, SPECIES_KANGASKHAN_MEGA, ABILITY_PARENTAL_BOND, HP_HIGHER_THAN,   50},
    {FORM_CHANGE_BATTLE_HP_PERCENT_SEND_OUT, SPECIES_KANGASKHAN,      ABILITY_PARENTAL_BOND, HP_LOWER_EQ_THAN, 50},
    {FORM_CHANGE_BATTLE_HP_PERCENT_TURN_END, SPECIES_KANGASKHAN_MEGA, ABILITY_PARENTAL_BOND, HP_HIGHER_THAN,   50},
    {FORM_CHANGE_BATTLE_HP_PERCENT_TURN_END, SPECIES_KANGASKHAN,      ABILITY_PARENTAL_BOND, HP_LOWER_EQ_THAN, 50},
    {FORM_CHANGE_BATTLE_SWITCH_OUT,          SPECIES_KANGASKHAN},
#endif
