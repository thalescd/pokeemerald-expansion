...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_STEEL_ROLLER] =
    {
        ...
        .description = COMPOUND_STRING(
            "Destroys terrain. Deals half\n"
            "damage without terrain."),
    ...
    [MOVE_ESPER_WING] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_9 ? 85 : 75,
        .type = TYPE_PSYCHIC,
