...
#define OW_FRISK_ITEM_RARITY        TRUE       // If TRUE, if a Pokémon with Frisk is leading the party, the wild held item rate is increased to 50%/30%, like Compound Eyes.
