...
#define B_MISSING_BADGE_CATCH_MALUS     FALSE      // In Gen9, a penalty is added to the catch rate if trying to catch a mon 5 levels above the current obedience level, based on the number of gym badges obtained.
...
#define B_EVOLUTION_AFTER_WHITEOUT      FALSE      // In Gen6+, Pokemon that qualify for evolution after battle will evolve even if the player loses.
