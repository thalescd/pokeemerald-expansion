...
// Stat settings
#define B_BADGE_BOOST               FALSE      // In Gen4+, Gym Badges no longer boost a Pokémon's stats. (Gen2 does not include the additional boost to the type matching the gym the badge is from)
