...
#define B_PARENTAL_BOND_DMG         GEN_6      // In Gen7+, Parental Bond's second hit does 25% of the initial hit's damage instead of 50%.
...
#define B_OVERWORLD_WEATHER_OVERRIDE    GEN_8      // In Gen9+, overworld weather cannot be overridden.
...
#define B_MISSING_BADGE_CATCH_MALUS     FALSE      // In Gen9+, a penalty is added to the catch rate when trying to catch a Pokémon 5 levels above the current obedience level, based on the number of Badges obtained.
...
#define B_EVOLUTION_AFTER_WHITEOUT      FALSE      // In Gen6+, Pokémon that qualify for evolution after battle will evolve even if the player loses.
...
#define B_ALWAYS_OBEY                   TRUE       // If this is set to TRUE the Pokémon will always obey
