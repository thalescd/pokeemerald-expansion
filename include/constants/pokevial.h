...
// Modes for the "pokevial" script command
#define VIAL_GET     0
...
// Measurements
#define EMPTY_VIAL         0
#define VIAL_STANDARD_DOSE 1 // Doses consumed by a single use of the Pokévial
#define VIAL_MIN_SIZE      1
#define VIAL_MAX_SIZE      15 // Hard cap: Size/Dose are packed into a 4-bit bitfield each in SaveBlock1
