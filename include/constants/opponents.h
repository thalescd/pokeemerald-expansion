...
#define TRAINER_CASSIUS_ROUTE_110           855
// Mossdeep Gym is a 2 vs 2 multi battle, which needs one trainer id per leader.
#define TRAINER_TATE                        856
#define TRAINER_LIZA                        857

// NOTE: Because each Trainer uses a flag to determine when they are defeated, there is only space for 7 additional trainers before trainer flag space overflows
