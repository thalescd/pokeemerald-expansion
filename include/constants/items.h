...
enum __attribute__((packed)) Item
{
    ...
    ITEM_ENDLESS_CANDY = 829,

    // Legends Z-A Mega Stones
    ITEM_CLEFABLITE = 830,
    ITEM_VICTREEBELITE = 831,
    ITEM_STARMINITE = 832,
    ITEM_DRAGONINITE = 833,
    ITEM_MEGANIUMITE = 834,
    ITEM_FERALIGITE = 835,
    ITEM_SKARMORITE = 836,
    ITEM_FROSLASSITE = 837,
    ITEM_EMBOARITE = 838,
    ITEM_EXCADRITE = 839,
    ITEM_SCOLIPITE = 840,
    ITEM_SCRAFTINITE = 841,
    ITEM_EELEKTROSSITE = 842,
    ITEM_CHANDELURITE = 843,
    ITEM_CHESNAUGHTITE = 844,
    ITEM_DELPHOXITE = 845,
    ITEM_GRENINJITE = 846,
    ITEM_PYROARITE = 847,
    ITEM_FLOETTITE = 848,
    ITEM_MALAMARITE = 849,
    ITEM_BARBARACITE = 850,
    ITEM_DRAGALGITE = 851,
    ITEM_HAWLUCHANITE = 852,
    ITEM_ZYGARDITE = 853,
    ITEM_DRAMPANITE = 854,
    ITEM_FALINKSITE = 855,
    ...
    ITEM_DARKRANITE = 857,
    ITEM_ZERAORITE = 858,
    ITEM_RAICHUNITE_X = 859,
    ITEM_RAICHUNITE_Y = 860,
    ITEM_CHIMECHITE = 861,
    ITEM_ABSOLITE_Z = 862,
    ITEM_STARAPTITE = 863,
    ITEM_GARCHOMPITE_Z = 864,
    ITEM_LUCARIONITE_Z = 865,
    ITEM_GOLURKITE = 866,
    ITEM_MEOWSTICITE = 867,
    ITEM_CRABOMINITE = 868,
    ITEM_GOLISOPITE = 869,
    ITEM_MAGEARNITE = 870,
    ITEM_SCOVILLAINITE = 871,
    ITEM_BAXCALIBRITE = 872,
